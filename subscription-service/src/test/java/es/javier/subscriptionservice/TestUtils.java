...
public class TestUtils {
    ...
    public static Subscription generateRandomSubscription(String email) {
        return generateRandomSubscription(email, null, null);
    }
    ...
    public static SubscriptionResponseInformation extractResponseFromMockMvcResult(MvcResult result) throws UnsupportedEncodingException, JsonProcessingException {
        String rawJson = result.getResponse().getContentAsString();
        SubscriptionResponseInformation response = MAPPER.readValue(rawJson, SubscriptionResponseInformation.class);
